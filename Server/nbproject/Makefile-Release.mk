...
${OBJECTDIR}/InGameController.o: InGameController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InGameController.o InGameController.cpp

${OBJECTDIR}/InLobbyController.o: InLobbyController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InLobbyController.o InLobbyController.cpp

${OBJECTDIR}/InLoginController.o: InLoginController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InLoginController.o InLoginController.cpp

${OBJECTDIR}/InRoomController.o: InRoomController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InRoomController.o InRoomController.cpp
...
${OBJECTDIR}/RoomMap.o: RoomMap.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RoomMap.o RoomMap.cpp
