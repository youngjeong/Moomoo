...
}S_PROTOCOL_LOBBY_MAKE_ROOM_REQ;
...
typedef struct _PROTOCOL_PLAYER_CHANGE_READY_STATUS_REQ : _protocol {
   _header header;
   int status;

   _PROTOCOL_PLAYER_CHANGE_READY_STATUS_REQ()
   {
      header.protocolID = PROTOCOL_PLAYER_CHANGE_READY_STATUS_REQ;
   }
} S_PROTOCOL_PLAYER_CHANGE_READY_STATUS_REQ;
...
typedef struct _PROTOCOL_PLAYER_CHANGE_READY_STATUS_ACK : _protocol {
   ...
   {
      header.protocolID = PROTOCOL_PLAYER_CHANGE_READY_STATUS_ACK;
   }
